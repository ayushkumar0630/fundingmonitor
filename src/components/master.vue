        ...
        <div class="row">
          <div class="col-md-12">
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="desc-img">
                    <img src="@/assets/financial_dashboard.svg" id="financial_dashboard"></img>
                  </div>
                </div>
              </div>
          </div>
            ...
            <div class="card mb-5 mb-lg-0">
              <div class="card-body">
                ...
                <ul class="fa-ul">
                  ...
                  <li><span class="fa-li"><i class="fas fa-check"></i></span>Single Company</li>
                  <li><span class="fa-li"><i class="fas fa-check"></i></span>1GB Limit</li>
            ...
            <div class="card mb-5 mb-lg-0">
              <div class="card-body">
                ...
                <ul class="fa-ul">
                  <li><span class="fa-li"><i class="fas fa-check"></i></span>Single User</li>
                  <li><span class="fa-li"><i class="fas fa-check"></i></span>Single Company</li>
                  <li><span class="fa-li"><i class="fas fa-check"></i></span>5GB Limit</li>
          ...
          <div class="col-lg-4">
            <div class="card">
              <div class="card-body">
                ...
                <ul class="fa-ul">
                  <li><span class="fa-li"><i class="fas fa-check"></i></span>Single User</li>
                  <li><span class="fa-li"><i class="fas fa-check"></i></span>Multiple Companies</li>
                  <li><span class="fa-li"><i class="fas fa-check"></i></span>No Storage Limit</li>
