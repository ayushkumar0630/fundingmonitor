            ...
            <div class="product-description">
              <div class="row">
                  ...
                  <div class="desc-img offset-md-3">
                    ...
                    >
                      ...
                      <ellipse
                        ...
                        opacity="0.1"
                      ></ellipse>
                      <ellipse cx="833.1" cy="723.1" rx="40.21" ry="6.8" fill="#c1b9f1"></ellipse>
                      <path
                ...
                <div class="col-md-6">
                  <p
                    class="section-title"
                  >Have you lost data, money or customers because your background jobs stopped running?</p>
                  <p
                    class="section-sub-title"
                  >Cronhub makes sure you never face any of these issues by monitoring all your background jobs & alerting you if anything goes off so you can focus on growing your business.</p>
                </div>
              </div>
            </div>
          </div>
